...
## [SICSS Boot camp](https://compsocialscience.github.io/summer-institute/boot_camp)
**What is this?**
Excerpt from site: SICSS Boot camp is an online training program designed to provide you with beginner-level skills in coding so that you can follow the more advanced curriculum we teach at the partner locations of the Summer Institutes in Computational Social Science. The videos and materials linked below are designed for complete beginners and are best viewed as a sequence since each video builds upon content introduced in previous tutorials.
1. Link to Boot camp here: https://compsocialscience.github.io/summer-institute/boot_camp
