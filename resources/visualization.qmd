...
1.
Link to all apps here: <https://ggplot2tor.com/apps> 1.
Link to Aesthetics finder here: <https://ggplot2tor.com/aesthetics> 1.
Link to Scales finder here: <https://ggplot2tor.com/scales> 1.
Link to Theme finder: <https://ggplot2tor.com/theme>
